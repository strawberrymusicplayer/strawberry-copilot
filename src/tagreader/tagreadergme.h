...
class TagReaderGME : public TagReaderBase {
 ...
 public:
  ...
  TagReaderResult WriteFile(const QString &filename, const Song &song, const SaveTagsOptions save_tags_options, const SaveTagCoverData &save_tag_cover_data, const ID3v2Version id3v2_version) const override;
